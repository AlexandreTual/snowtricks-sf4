    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('hash', RepeatedType::class, [
                ...
                'required' => true,
                'first_options' => ['label' => 'Mot de passe', 'attr' => ['placeholder' => 'Taper votre nouveau mot de passe...']],
            ...
            ->add('description', TextType::class, ['label' => 'Description détaillée', 'attr' => ['placeholder' => "Lachez vous, c'est le moment de nous parler de vous en détails..."]])
